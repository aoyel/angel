...
class StringHelper {
	...
	static public function text2html($txt)
	{
		$txt = str_replace("  ", "　", $txt);
		$txt = str_replace("<", "&lt;", $txt);
		$txt = str_replace(">", "&gt;", $txt);
	...
	const STRING_RAND_TYPE_WORD = 0x00;
	const STRING_RAND_TYPE_NUMBER = 0x01;
	const STRING_RAND_TYPE_UPPER_WORD = 0x03;
	const STRING_RAND_TYPE_LOWER_WORD = 0x04;
	const STRING_RAND_TYPE_CHINESE_CHARACTER = 0x05;
	const STRING_RAND_TYPE_CHARACTER = 0x06;	
